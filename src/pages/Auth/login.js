      ...
      <div className="bg-white p-8 rounded-xl shadow-md w-full max-w-md">
        ...
        <form className="flex flex-col gap-4">
          <Input
            placeholder="Email"
            type="email"
            className="block w-full rounded-md bg-white/5 px-3 py-1.5 text-base text-gray-700 placeholder:text-gray-400 focus:outline-2 focus:outline-indigo-500 sm:text-sm"
          />
          <Input
            ...
            className="block w-full rounded-md bg-white/5 px-3 py-1.5 text-base text-gray-700 placeholder:text-gray-400 focus:outline-2 focus:outline-indigo-500 sm:text-sm"
          />
          <Button type="submit" className="bg-emeraldGreen">Login</Button>
        </form>
